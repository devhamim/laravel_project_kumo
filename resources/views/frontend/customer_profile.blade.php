					...
					<div class="row align-items-start justify-content-between">
						...
						<div class="col-12 col-md-12 col-lg-8 col-xl-8">
                            @if(session('password_Wrong'))
                               <div class="alert alert-warning">{{ session('password_Wrong') }}</div>
                            @endif
							<!-- row -->
							<div class="row align-items-center">
								<form class="row m-0" action="{{ route('customer.profile.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
									<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
										<div class="form-group">
											<label class="small text-dark ft-medium">First Name *</label>
											<input type="text" value="{{ Auth::guard('customerlogin')->user()->name }}" class="form-control" name="name" placeholder="First Name" />
										</div>
									</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
										<div class="form-group">
											...
											<input type="text" name="email" value="{{ Auth::guard('customerlogin')->user()->email }}" class="form-control" placeholder="Email ID" />
										</div>
									</div>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 m-auto">
										<div class="form-group m-auto">
											<button type="submite" class="btn btn-dark">Save Changes</button>
										</div>
									</div>
