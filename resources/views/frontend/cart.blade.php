...
@if(App\Models\card::where('customer_id', Auth::guard('customerlogin')->id())->count() == 0)
	<!-- ======================= Product Detail ======================== -->
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12 col-md-10 col-lg-8 col-xl-6 text-center">
					<!-- Icon -->
					<div class="p-3 d-inline-flex align-items-center justify-content-center circle bg-light-warning text-danger mx-auto mb-4"><i style="font-size: 30px" class="fa fa-shopping-cart " aria-hidden="true"></i></div>
						<!-- Heading -->
					<h2 class="mb-2 ft-bold mb-5">Your Cart is Empty</h2>
						<!-- Button -->
        ...
        <div class="row justify-content-between">
            ...
            @csrf
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col d-flex align-items-center justify-content-between">
                                    <div class="cart_single_caption pl-2">
                                        ...
                                        <h4 class="fs-md ft-medium mb-3 lh-1">TK {{ $cart->rel_to_prodact->after_discount }}</h4>
                ...
                <div class="row align-items-end justify-content-between mb-10 mb-md-0">
                    <div class="col-12 col-md-auto mfliud ml-5 pl-5">
                    ...
                    <div class="col-12 col-md-7">
                        ...
                        <form class="mb-7 mb-md-0" action="{{ route('cart') }}" method="GET">
                            ...
                            <div class="row form-row">
                                <div class="col">
                                <input class="form-control" name="coupon" type="text" value="{{ @$_GET['coupon'] }}" placeholder="Enter coupon code*">
                                </div>
                                <div class="col-auto">
                ...
                <div class="card mb-4 gray mfliud">
                  <div class="card-body">
                    <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                      ...
                      {{-- <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                        <span>Discount</span> <span class="ml-auto text-dark ft-medium">{{ $type == 2?'TK':'' }} {{ $discount }} {{ $type == 1?'%':'' }}</span>
                      </li> --}}
                      <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                        <span>Discount</span> <span class="ml-auto text-dark ft-medium">TK {{ $type == 1?$subtotal*$discount/100:$discount }}</span>
                      </li>
                      <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                        @php
                            if($type == 1){
